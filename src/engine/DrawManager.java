...
public final class DrawManager {
	...
	public void drawHelp(final Screen screen, final int insNum){
...
//				"select with w+s / arrows, confirm with space";
		...
		switch (insNum) {
			case 0:
				instructionsString =
						"Select with W or S, Confirm with Space";
				break;
			case 1:
				instructionsString =
	...
	public void drawHelpMenu(final Screen screen, final int code) {
		...
		if (code == 9)
			...
			backBufferGraphics.setColor(Color.WHITE);
		drawCenteredRegularString(screen, OpString, screen.getHeight()/3);
		if (code == 10)
			backBufferGraphics.setColor(Color.GREEN);
		else
			backBufferGraphics.setColor(Color.WHITE);
		drawCenteredRegularString(screen, ItemString, screen.getHeight()/3
				+ fontRegularMetrics.getHeight() * 2);
		if (code == 1)
			backBufferGraphics.setColor(Color.GREEN);
		else
	...
	public void drawHelpOperation(final Screen screen, final int code) {
		...
		backBufferGraphics.setColor(Color.GREEN);
		drawCenteredRegularString(screen, backString, screen.getHeight() * 8 / 9);
	}

	public void drawHelpItems(final Screen screen, final int code) {
...
//		backBufferGraphics.drawString(info3, screen.getWidth() *2/5, screen.getHeight() * 8/10);
	...
	public void drawSaveRows(final Screen screen, final int mCode) {
		String slot1 = "Slot 1";
		String slot2 = "Slot 2";
		String slot3 = "Slot 3";
		String backString = "Exit";
	...
	public void drawSaveCols (final Screen screen, final int sdCode) {
		String start1 = "Start";
